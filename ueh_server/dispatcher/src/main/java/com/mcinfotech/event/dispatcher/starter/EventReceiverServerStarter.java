package com.mcinfotech.event.dispatcher.starter;
...
import com.mcinfotech.event.dispatcher.server.ReceiverServer;
...
public class EventReceiverServerStarter {
	...
	public void start() {
		AsyncPool.asyncDo(() -> {
			...
			try {
				receiverServer.startNettyServer(probe.getPort());
			} catch (Exception e) {
